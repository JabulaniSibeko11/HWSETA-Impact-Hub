...
namespace HWSETA_Impact_Hub.Migrations
{
    ...
    [Migration("20260308095915_addColumnsTobeneficiary")]
    partial class addColumnsTobeneficiary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HWSETA_Impact_Hub.Domain.Entities.AdminChatProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AdminChatProfiles", (string)null);
                });
            ...
            modelBuilder.Entity("HWSETA_Impact_Hub.Domain.Entities.BeneficiaryFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BeneficiaryFeedbacks", (string)null);
                });
            ...
            modelBuilder.Entity("HWSETA_Impact_Hub.Domain.Entities.BeneficiaryFormInvite", b =>
                {
                    ...
                    b.Property<DateTime?>("ExpiryOnUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("HWSETA_Impact_Hub.Domain.Entities.ConversationMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("AdminChatProfileId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("BeneficiaryFormInviteId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsFormShareMessage")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.HasIndex("AdminChatProfileId");

                    b.HasIndex("BeneficiaryFormInviteId");

                    b.HasIndex("BeneficiaryId");

                    b.HasIndex("FormPublishId");

                    b.HasIndex("ThreadId", "SentOnUtc");

                    b.ToTable("ConversationMessages", (string)null);
                });

            modelBuilder.Entity("HWSETA_Impact_Hub.Domain.Entities.ConversationThread", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("HasUnreadBeneficiaryMessage")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("HWSETA_Impact_Hub.Domain.Entities.ConversationMessage", b =>
                {
                    b.HasOne("HWSETA_Impact_Hub.Domain.Entities.AdminChatProfile", "AdminChatProfile")
                        .WithMany()
                        .HasForeignKey("AdminChatProfileId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("HWSETA_Impact_Hub.Domain.Entities.BeneficiaryFormInvite", "BeneficiaryFormInvite")
                        .WithMany()
                        .HasForeignKey("BeneficiaryFormInviteId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("HWSETA_Impact_Hub.Domain.Entities.ConversationThread", "Thread")
                        .WithMany("Messages")
                        .HasForeignKey("ThreadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AdminChatProfile");

                    b.Navigation("Beneficiary");

                    b.Navigation("BeneficiaryFormInvite");
